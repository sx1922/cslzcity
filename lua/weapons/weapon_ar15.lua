...
SWEP.PrintName = "AR-15半自动步枪"
SWEP.Author = "ArmaLite"
SWEP.Instructions = "AR-15式步枪是一种轻型半自动步枪,基于或类似于柯尔特AR-15设计。柯尔特型号去除了其前身——原始ArmaLite AR-15——的选择射击功能,后者是尤金·斯通纳设计的AR-10的缩小型。它与军用M16步枪密切相关。AR-15是保卫财产的优良步枪。口径5.56×45毫米"
