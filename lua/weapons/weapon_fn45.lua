...
SWEP.PrintName = "FNX-45手枪" -- FNX-45手枪
SWEP.Author = "FNH-USA"
SWEP.Instructions = "FN FNX手枪系列是由FN America(品牌FNH USA)在南卡罗来纳州哥伦比亚制造的半自动聚合物框架手枪。该手枪有9×19毫米Parabellum、.40 S&W和.45 ACP口径版本。此版本发射.45 ACP"--bruh too lazy to make .45 acp
SWEP.Category = "武器 - 手枪"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
