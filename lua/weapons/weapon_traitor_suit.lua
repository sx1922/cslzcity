...
SWEP.PrintName = "伪装服"
SWEP.Instructions = "一套简单的服装,连同面具,可以帮助你隐藏身份,你的衣服会留在手提箱里,以后你可以再穿上。"
...
if CLIENT then
    ...
    function SWEP:OpenCostumeMenu()
        if self.IsCostumeActive then
            notification.AddLegacy("你必须先脱下当前的伪装服！", NOTIFY_ERROR, 3)
        ...
        self.CostumeMenu:SetTitle("伪装服选择")
