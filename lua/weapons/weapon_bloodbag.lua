...
SWEP.PrintName = "血袋"
SWEP.Instructions = "装有识别血液和输血必要器械的塑料袋。可用于治疗大量失血。"
SWEP.Category = "ZCity 医疗"
SWEP.Spawnable = true
SWEP.Primary.Wait = 1
SWEP.Primary.Next = 0
SWEP.HoldType = "slam"
...
if SERVER then
	...
	function SWEP:Think()
		...
		self.modeNames[1] = self:GetNetVar("modeValues", {})[1] == 0 and modeStr .. " | 受血者: " .. ent.organism.bloodtype or modeStr .. " | 袋内: "..self:GetNetVar("type","o-").." | 受血者: "..ent.organism.bloodtype
	end
