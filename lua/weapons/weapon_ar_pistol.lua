...
SWEP.PrintName = "AR-15手枪" -- AR-15手枪
SWEP.Author = "Colt's Manufacturing Company"
SWEP.Instructions = "这款钢/聚合物AR-15半自动手枪口径为5.56x45。枪管短于步枪的16英寸法定长度，并配有手枪缓冲管或稳定支架代替枪托，为长枪管同类产品提供了紧凑而强大的替代方案。该手枪的紧凑尺寸使其可在小空间内使用，其多功能性和可定制性在民用市场上开辟了一片天地。作为AR平台多功能性的证明，AR-15手枪象征着个人防卫和休闲射击之间的平衡。"
SWEP.Category = "武器 - 手枪"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
...
SWEP.FakeBodyGroups = "0112255300230"
...
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {ironsight = Vector(-12, 1.3, 0.05), picatinny = Vector(-14, 1.3, 0.05)},
		["removehuy"] = {
			[1] = "null"
		}
	}
