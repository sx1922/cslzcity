...
SWEP.PrintName = "暴怒-13兴奋剂" -- 暴怒-13
SWEP.Instructions = "Fury-13（请勿与\"Furry-13\"混淆，后者是一种无关的病原体病毒株）是一种极其强效的刺激药物。它不是\"修改\"你的身体运作方式，而是提供额外的资源，让你变得比以往更强大。副作用可能包括永久性脑损伤。请勿对感染者使用。"
