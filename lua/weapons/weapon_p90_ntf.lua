-- 九尾狐独立 P90（homigrad_base）：45 伤（RXsend hook 对人类强制 45、对 SCP 100）、垂直后坐力 -97%、水平后坐力 -95%、开火抖动 -96%、开镜 +80%
SWEP.Base = "homigrad_base"
SWEP.Spawnable = true
SWEP.AdminOnly = false
SWEP.PrintName = "FN P90（九尾狐特供）"
SWEP.Author = "RX Mission Intro"
SWEP.Instructions = "机动特遣队九尾狐特供冲锋枪，5.7x28 mm"
...
local VERT_RECOIL_MUL = 0.024
local HORIZ_RECOIL_MUL = 0.032
local FIRE_SHAKE_MUL = 0.0224

-- 后坐力倍率（Spray 表由 homigrad_base 在 Register 时继承，勿在文件顶层写 SWEP.Spray[i]）
SWEP.SprayRand = {
...
SWEP.Ergonomics = 1.1 * 1.8
SWEP.SpreadMulZoom = 1.5 * 0.2
