...
SWEP.PrintName = "AK-200突击步枪" -- AK-200
SWEP.Author = "Izhevsk Machine-Building Plant"
SWEP.Instructions = "发射5.45x39毫米弹药的自动步枪\n\n射速为每分钟700发"
SWEP.Category = "武器 - 突击步枪"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
...
SWEP.AttachmentAng = Angle(0,-2,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "079000403210000"
...
SWEP.WepSelectIcon2 = Material("vgui/icons/ico_ak200.png")
SWEP.WepSelectIcon2box = false
SWEP.IconOverride = "vgui/icons/ico_ak200.png"
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-24, 1.5, -0.15)},
	},
	barrel = {
