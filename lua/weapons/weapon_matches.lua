...
SWEP.Instructions = "这是一个装有火柴的纸板盒。它的一边有粗糙的点火面,用于点燃里面的火柴。\n\n按住左键点燃火柴。"
...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		if IsValid(tr.Entity) and (tr.Entity.OnMatches or tr.Entity.shouldburn) then
			draw.SimpleText( "点燃物体", "HomigradFont", toScreen.x + 3, toScreen.y + 27, color_black, TEXT_ALIGN_CENTER )
			draw.SimpleText( "点燃物体", "HomigradFont", toScreen.x, toScreen.y + 25, colred, TEXT_ALIGN_CENTER )
		end
	end
end
