...
SWEP.PrintName = "VX毒剂小瓶"
SWEP.Instructions = "VX是一种极其有毒的有机磷类合成化合物,具体来说是一种硫代膦酸酯。在神经毒剂类别中,它是在翻译早期农药研究中有机磷毒性发现后,为化学战中的军事用途而开发的。"
...
if SERVER then
	...
	hook.Add("Org Think", "poison2",function(owner, org, timeValue)
		...
		if (not org.poison2notificate) and ((org.poison2 + 15) < CurTime()) then
			...
			org.owner:Notify("有什么东西阻止我正常呼吸。", true, "poison2", 3)
