...
SWEP.PrintName = "绷带"
SWEP.Instructions = "一卷纱布绷带,可以帮助止血轻度出血。由于绷带不在包装中,它已消毒的可能性很小。右键对他人使用。"
...
if CLIENT then
	SWEP.HowToUseInstructions = "<font=ZCity_Tiny>"..string.upper( (input.LookupBinding("+use") or "请绑定 +USE 键。请在控制台输入 \"bind e +use\"") ).." 以拾取</font>"
end
