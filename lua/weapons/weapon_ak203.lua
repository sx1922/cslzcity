...
SWEP.PrintName = "AK-203突击步枪"
SWEP.Author = "Izhevsk Machine-Building Plant"
SWEP.Instructions = "这是一款威力非凡的武器,这支7.62×39毫米口径的导气式可选射击模式步枪采用旋转闭锁设计,可选择半自动或全自动射击模式,是20世纪中期苏联军事实力的缩影。射速约600发/分钟,配备10、20或30发可拆卸弹匣,由著名的米哈伊尔·卡拉什尼科夫设计的这款步枪,是苏联技术进步的象征。其坚固的设计和在恶劣条件下的可靠性能,使其成为全球战争中留下不可磨灭印记的武器"
