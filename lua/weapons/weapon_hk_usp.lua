...
SWEP.PrintName = "HK USP" -- HK USP
SWEP.Author = "Heckler & Koch"
SWEP.Instructions = "发射9x19毫米弹药的手枪"
SWEP.Category = "武器 - 手枪"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
...
SWEP.IconOverride = "pwb2/vgui/weapons/usptactical.png"

SWEP.CustomShell = "9x19"
--SWEP.EjectPos = Vector(-5,2,-6)
...
SWEP.LocalMuzzlePos = Vector(5.759,0,2.18)
...
SWEP.Primary.Sound = {"zcitysnd/sound/weapons/m45/m45_fp.wav", 75, 90, 100}
