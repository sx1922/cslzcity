...
SWEP.PrintName = "AS Val特种消音步枪"
SWEP.Author = "TsNIITochmash Tula arms plant"
SWEP.Instructions = "这是一支极其强大的武器,这支9x39毫米钢/聚合物导气式可选射击模式的一体化消音步枪ASVAL,是20世纪80年代中期苏联特种作战部队的缩影。配备20发弹匣、折叠枪托和握把,专为精准和隐蔽设计。其独特设计可发射亚音速弹药,将枪口闪光和枪声降至极低。这使ASVAL成为熟练使用者手中的强大武器,象征着特种作战的无声致命效率。\n\n射速900发/分钟"
