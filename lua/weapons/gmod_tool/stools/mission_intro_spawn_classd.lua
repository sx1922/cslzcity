TOOL.Category = "RX D级人员"
TOOL.Name = "D级人员出生点"
TOOL.Command = nil
TOOL.Information = {
	{ name = "left", text = "放置 D 级人员出生点" },
...
local MI_FACTION = "class_d_personnel"
...
function TOOL.BuildCPanel(panel)
	panel:Help("左键：放置 D 级人员专用入场出生点")
	panel:Help("右键：删除瞄准的出生点")
	panel:Help("重装：清除地图上全部出生点")
	panel:NumSlider("朝向偏移 (Yaw)", "mission_intro_spawn_classd_yaw", -180, 180, 0)
	panel:Help("D 级人员会优先在此类出生点（或通用点）复活。")
	panel:Help("须切换到工具枪并选中本工具，才能看到地面齿轮标记。")
	panel:Help("控制台 mission_intro_show_spawns 可强制显示标记。")
end

if CLIENT then
	language.Add("tool.mission_intro_spawn_classd.name", "D级人员出生点")
	language.Add("tool.mission_intro_spawn_classd.desc", "放置 D 级人员任务入场出生点")
	language.Add("tool.mission_intro_spawn_classd.left", "放置出生点")
	language.Add("tool.mission_intro_spawn_classd.right", "删除出生点")
	language.Add("tool.mission_intro_spawn_classd.reload", "清除全部")
end
