...
local MI_FACTION = "mtf_taskforce"
...
function TOOL.BuildCPanel(panel)
	panel:Help("左键：放置机动特遣队专用出生点")
	panel:Help("右键：删除瞄准的出生点")
	panel:Help("重装：清除地图上全部出生点")
	panel:NumSlider("朝向偏移 (Yaw)", "mission_intro_spawn_mtf_yaw", -180, 180, 0)
	panel:Help("机动特遣队入场玩家只会在此类出生点（或通用点）复活。")
end

if CLIENT then
	language.Add("tool.mission_intro_spawn_mtf.name", "机动特遣队出生点")
	language.Add("tool.mission_intro_spawn_mtf.desc", "放置机动特遣队设施入场出生点")
	language.Add("tool.mission_intro_spawn_mtf.left", "放置 MTF 出生点")
	language.Add("tool.mission_intro_spawn_mtf.right", "删除出生点")
	language.Add("tool.mission_intro_spawn_mtf.reload", "清除全部")
end
