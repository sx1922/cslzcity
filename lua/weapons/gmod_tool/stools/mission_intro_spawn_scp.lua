...
function TOOL.BuildCPanel(panel)
	panel:Help("左键：放置 SCP 专用出生点")
	panel:Help("右键：删除瞄准的出生点")
	panel:Help("重装：清除地图上全部出生点")
	panel:NumSlider("朝向偏移 (Yaw)", "mission_intro_spawn_scp_yaw", -180, 180, 0)
	panel:Help("SCP 入场玩家只会在此类出生点（或通用点）复活。")
end

if CLIENT then
	language.Add("tool.mission_intro_spawn_scp.name", "SCP 出生点")
	language.Add("tool.mission_intro_spawn_scp.desc", "放置 SCP 设施入场出生点")
	language.Add("tool.mission_intro_spawn_scp.left", "放置 SCP 出生点")
	language.Add("tool.mission_intro_spawn_scp.right", "删除出生点")
	language.Add("tool.mission_intro_spawn_scp.reload", "清除全部")
end
