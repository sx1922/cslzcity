...
local MI_FACTION = "hammerfall_maintenance"
...
function TOOL.BuildCPanel(panel)
	panel:Help("左键：放置落锤维修小队专用出生点")
	panel:Help("右键：删除瞄准的出生点")
	panel:Help("重装：清除地图上全部出生点")
	panel:NumSlider("朝向偏移 (Yaw)", "mission_intro_spawn_hammerfall_maintenance_yaw", -180, 180, 0)
	panel:Help("维修小队入场玩家只会在此类出生点（或通用点）复活。")
end

if CLIENT then
	language.Add("tool.mission_intro_spawn_hammerfall_maintenance.name", "落锤维修队出生点")
	language.Add("tool.mission_intro_spawn_hammerfall_maintenance.desc", "放置落锤维修小队任务入场出生点")
	language.Add("tool.mission_intro_spawn_hammerfall_maintenance.left", "放置维修队出生点")
	language.Add("tool.mission_intro_spawn_hammerfall_maintenance.right", "删除出生点")
	language.Add("tool.mission_intro_spawn_hammerfall_maintenance.reload", "清除全部")
end
