...
local MI_FACTION = "facility_security"
...
function TOOL.BuildCPanel(panel)
	panel:Help("左键：放置安保部门与 CI 间谍专用出生点（与科研设施出生点分离）")
	panel:Help("右键：删除瞄准的出生点")
	panel:Help("重装：清除地图上全部出生点")
	panel:NumSlider("朝向偏移 (Yaw)", "mission_intro_spawn_facility_security_yaw", -180, 180, 0)
	panel:Help("须切换到工具枪并选中本工具，才能看到已放置出生点的齿轮预览。")
	panel:Help("未放置安保点时，安保/CI 间谍会回退到中性或未匹配的出生点。")
end

if CLIENT then
	language.Add("tool.mission_intro_spawn_facility_security.name", "设施安保出生点")
	language.Add("tool.mission_intro_spawn_facility_security.desc", "放置安保与 CI 间谍任务入场出生点")
	language.Add("tool.mission_intro_spawn_facility_security.left", "放置出生点")
	language.Add("tool.mission_intro_spawn_facility_security.right", "删除出生点")
	language.Add("tool.mission_intro_spawn_facility_security.reload", "清除全部")
end
