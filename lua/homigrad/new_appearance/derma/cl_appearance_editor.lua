...
local function CreateStyledAccessoryMenu(parent, title)
    ...
    function menu:AddNoneOption(onSelect)
        ...
        function ico:Paint(w, h)
            ...
            draw.SimpleText("无", "DermaDefault", w/2, h - ScreenScale(4), colors.mainText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
        end
...
function PANEL:PostInit()
    ...
    function loadPresetBtn:DoClick()
        ...
        if #presetList == 0 then
            surface.PlaySound("buttons/button10.wav")
            notification.AddLegacy("尚未保存任何预设！", NOTIFY_ERROR, 3)
            return
        end
        
        local presetMenu = vgui.Create("DFrame")
        presetMenu:SetTitle("加载预设")
        ...
        for _, presetName in SortedPairs(presetList) do
            ...
            function presetBtn:DoRightClick()
                ...
                confirmMenu:AddOption("删除 '" .. presetName .. "'", function()
    ...
    function hatSelector:DoClick()
        ...
        hatSelectMenu = CreateStyledAccessoryMenu(nil, "选择帽子")
    ...
    function faceSelector:DoClick()
        ...
        faceSelectorMenu = CreateStyledAccessoryMenu(nil, "选择面部装饰")
    ...
    function bodySelector:DoClick()
        ...
        bodySelectorMenu = CreateStyledAccessoryMenu(nil, "选择身体装饰")
