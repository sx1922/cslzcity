...
if CLIENT then
	...
	AddOptionPanel( "zmeyka_size", "slider", {desc = "基础大小",min = 10, max = 50}, "general" )
	AddOptionPanel( "zmeyka_gravity", "slider", {desc = "重力",min = 0, max = 30}, "general" )
	AddOptionPanel( "zmeyka_func", "slider", {desc = "外观",min = 1, max = 5}, "general" )
	AddOptionPanel( "zmeyka_legs", "switcher", {desc = "腿部"}, "general" )
	...
	local function CreateOptionsMenu()
		...
		MainFrame:SetTitle( "灵蛇设置" ) -- Set the title in the top left to "Derma Frame".
