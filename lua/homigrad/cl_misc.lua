...
--\\ Give our guns to NPCs
	hook.Add("PopulateMenuBar", "PopulateNPCweps", function(menubar)
		local bar = menubar:AddOrGetMenu("Z-City 武器覆盖")
		local weaponlist = weapons.GetList()

		bar:AddCVar("无", "gmod_npcweapon", "none")
		bar:AddSpacer()
		...
		for _, wep in ipairs(weaponlist) do
			...
			if (based(classname, "homigrad_base") or based(classname, "weapon_melee") or classname == "weapon_melee" or based(classname, "weapon_medkit_sh") or classname == "weapon_medkit_sh") and wep.Spawnable then
				local category = wep.Category or "ZCity 其他"
				...
				list.Add("NPCUsableWeapons", {
					class = classname,
					title = wep.PrintName,
					category = wep.Category or "ZCity 其他"
				})
			end
		end
	end)
...
--\\ Spawnmenu category icons
	local categories = {
		["武器 - 突击步枪"] = "pwb/sprites/akm", -- vgui/inventory/weapon_nam_akm
		["武器 - 卡宾枪"] = "vgui/wep_jack_hmcd_assaultrifle",
		["武器 - 爆炸物"] = "pluv/toosilly.png",
		["武器 - 榴弹发射器"] = "vgui/inventory/weapon_rpg7",
		["武器 - 冲锋手枪"] = "vgui/hud/tfa_ins2_mp7", -- vgui/inventory/weapon_uzi
		["武器 - 机枪"] = "vgui/hud/tfa_kopter_pkm",
		["武器 - 近战武器"] = "vgui/wep_jack_hmcd_hammer",
		["武器 - 其他"] = "vgui/wep_jack_hmcd_crossbow",
		["武器 - 手枪"] = "entities/arc9_eft_m1911.png",
		["武器 - 霰弹枪"] = "pwb/sprites/m590a1",
		["武器 - 狙击步枪"] = "vgui/hud/tfa_ins2_sr25_eft",
		["ZCity 医疗物品"] = "vgui/wep_jack_hmcd_medkit",
		["ZCity 其他"] = "pluv/pluv.png",

		["ZCity 弹药"] = "vgui/hud/hmcd_round_4630",
		["ZCity 护甲"] = "vgui/icons/armor01",
		["ZCity 配件 - 握把"] = "entities/eft_attachments/foregrips/ash12.png",
		["ZCity 配件 - 弹匣井"] = "entities/eft_ak_attachments/mag/545drum.png",
		["ZCity 配件 - 枪口"] = "vgui/icons/silencer_assaultrifle",
		["ZCity 配件 - 瞄准镜"] = "vgui/icons/sights_aimpoint",
		["ZCity 配件 - 下挂"] = "vgui/icons/laser_long",
	}
