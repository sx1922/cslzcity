...
module[2] = function(owner, org, mulTime)
	...
	if org.isPly and not org.otrub and org.blood < 2900 then org.owner:Notify(math.random(2) == 1 and "我感觉不到任何东西..." or (math.random(2) == 1 and "我想我现在就要晕倒了...") or "我感觉不太舒服...",60,"blood2",0) end
