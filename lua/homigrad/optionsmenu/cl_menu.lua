...
hg.AddOptionPanel( "hg_potatopc", "switcher", {desc = "启用较弱的效果。适用于性能较弱的电脑"}, "optimization" )
hg.AddOptionPanel( "hg_dynamic_mags", "switcher", {desc = "启用\"浮动弹药HUD\"功能"}, "other" )
hg.AddOptionPanel( "hg_anims_draw_distance", "slider", {desc = "更改动画渲染距离\n可帮助提高FPS | 0 - 无限",min = 0,max = 4096}, "optimization" )
hg.AddOptionPanel( "hg_attachment_draw_distance", "slider", {desc = "更改配件渲染距离\n可帮助提高FPS | 0 - 无限",min = 0,max = 4096}, "optimization" )
hg.AddOptionPanel( "hg_old_notificate", "switcher", {desc = "启用旧版伤害通知（在聊天中）",min = 0,max = 4096}, "other" )
hg.AddOptionPanel( "hg_weaponshotblur_enable", "switcher", {desc = "启用射击时的模糊效果",min = 0,max = 4096}, "other" )
hg.AddOptionPanel( "hg_weaponshotblur_mul", "slider", {desc = "射击时模糊效果的强度倍数",min = 0,max = 1,decimals = 3}, "other" )
hg.AddOptionPanel( "hg_maxsmoketrails", "slider", {desc = "烟雾拖尾效果的最大数量（超过10会卡顿）",min = 0,max = 30,decimals = 0}, "optimization" )
hg.AddOptionPanel( "hg_optimise_scopes", "slider", {desc = "如果瞄准镜导致帧数下降，请启用此项（1 - 降低周围道具质量，2 - \"禁用\"主渲染）",min = 0,max = 2,decimals = 0}, "optimization" )
