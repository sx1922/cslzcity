					...
					if mouseClick == 1 or (organism.pain or 0) > 60 then
						...
						for context, phrases in pairs(contextPhrases[1]) do
							...
							tbl[#tbl + 1] = {
								...
								[2] = phraseContextNames[context] or context
							}
						end
						hg.CreateRadialMenu(tbl)
					end
				end,
				[2] = (organism.pain or 0) > 60 and ((organism.pain or 0) <= 100 and "痛苦大喊" or "痛苦呻吟") or (lply.PlayerClassName == "furry" and "喵") or "发语音\n右键 - 菜单"
			}
		end
	end)
end
