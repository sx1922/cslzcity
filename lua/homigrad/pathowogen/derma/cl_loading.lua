...
local BootStages = {
	[1] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[2] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[3] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("全局系统检测：", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[4] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("全局系统检测：", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("视觉系统: 正常", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 3 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("触觉系统: 正常", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 4 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("听觉系统: 正常", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 5 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("嗅觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("味觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[5] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("嗅觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("味觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Scan: 进行中", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[6] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("嗅觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("味觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Scan: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[7] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("味觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Scan: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Adjustment: 进行中", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[8] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("味觉系统: 未找到模块", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Scan: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Adjustment: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[9] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Memory Scan: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Memory Adjustment: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("意识系统初始化中...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[10] = function(init2)
		draw.SimpleText("系统启动初始化", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 版本: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Memory Adjustment: 完成", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("意识系统初始化中...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("echo \"祝你拥有非常 :3 的一天！\"", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 11 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
}
...
hook.Add("RenderScreenspaceEffects", "furload", function()
	if IsValid(hg.furload) and hg.furload.alpha != 255 then
		...
		draw.SimpleText("祝你拥有非常 :3 的一天！", "ZB_ProotOSMedium", sw * 0.5 + 2, sh * 0.8 + 2, ColorAlpha(color_black, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText("祝你拥有非常 :3 的一天！", "ZB_ProotOSMedium", sw * 0.5, sh * 0.8, ColorAlpha(bluewhite, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end)
