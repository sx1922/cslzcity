...
local text = "一种未知的 Pathowogen 病毒正在肆虐你所在的区域。你的位置现已进入立即隔离状态，直至另行通知。在此期间，我们会尽力为你找出撤离的方法。"
...
function PANEL:Paint(w, h)
	...
	surface.SetDrawColor(67, 10, 10, 50)
	...
	for i = 1, 10 do
		surface.SetDrawColor(144, 35, 62, 10)
	...
	draw.GlowingText("指挥官", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
...
vgui.Register("ZB_Dialogue", PANEL, "EditablePanel")