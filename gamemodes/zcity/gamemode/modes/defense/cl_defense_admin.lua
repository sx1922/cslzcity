...
function CreateAdminWaveMenu(subMode, currentWave, totalWaves, isActive)
    ...
    for i = 1, totalWaves do
        ...
        waveBtn.Paint = function(self, w, h)
            ...
            draw.SimpleText("第 " .. i .. " 波", "Defense_AdminText", w/2, h/2, ADMIN_MENU.TEXT_COLOR, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        end
    ...
    infoPanel.Paint = function(self, w, h)
        ...
        surface.DrawRect(0, 0, w, h)
        draw.SimpleText("点击波次编号可跳转到该波", "Defense_AdminInfo", w/2, h/2, Color(200, 200, 200), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
end
