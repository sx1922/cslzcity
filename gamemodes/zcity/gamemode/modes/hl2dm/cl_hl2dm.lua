...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | 半条命2 死亡竞赛", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
