...
function GM:ScoreboardShow()
	...
	local ServerName = GetHostName() or "Z-City | 开发者服务器 | #01"
	local tick
	...
	for i, ply in player.Iterator() do -- надо это говно переделать.
		...
		but.Paint = function(self, w, h)
			...
			surface.SetFont("ZB_InterfaceMediumLarge")
			surface.SetTextColor(col.r, col.g, col.b, col.a)
			local lengthX, lengthY = surface.GetTextSize(ply:Name() or "他退出了...")
			surface.SetTextPos(15, h / 2 - lengthY / 2)
			surface.DrawText(ply:Name() or "他退出了...")

			surface.SetFont("ZB_InterfaceMediumLarge")
			surface.SetTextColor(col.r, col.g, col.b, col.a)
			local lengthX, lengthY = surface.GetTextSize(ply:Ping() or "他退出了...")
			surface.SetTextPos(w - lengthX - 15, h / 2 - lengthY / 2)
			surface.DrawText(ply:Ping() or "他退出了...")
			end
...
concommand.Add("zb_snake", function() -- вот как здесь!
    ...
    function snakePanel:Paint(w, h)
        ...
        draw.SimpleText("得分：" .. score, "DermaDefault", 10, 10, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    end
